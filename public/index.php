                ...
                <div class="card shadow-sm border-0 p-4 p-md-5">
                    <div class="card-body">
                        ...
                        <div class="d-grid gap-3">
                            ...
                            <a href="solicitacao.php" class="btn btn-danger btn-lg py-3 fw-bold shadow-sm d-flex align-items-center justify-content-center gap-2">
                                <i class="bi bi-plus-circle-fill fs-4"></i>
                                <span>Registrar Chamado</span>
                            </a>

                            <!-- Botão 2: Login Administrativo -->
                            <a href="login.php" class="btn btn-outline-primary btn-lg py-3 fw-bold d-flex align-items-center justify-content-center gap-2">
